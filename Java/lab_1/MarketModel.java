...
public class MarketModel {
    ...
    void printValues() {
        System.out.print("\n------------------- \033[1;31mOUT\033[0m -------------------\n");
        System.out.printf(" Your initial price: %.3f\n" +
    ...
    boolean inputDemand() {
        ...
        System.out.println("Enter the coefficients for the \033[1;31mdemand function\033[0m:\n" +
    ...
    boolean inputOffer() {
        Scanner in = new Scanner(System.in);
        System.out.println("Enter the coefficients for the \033[1;31moffer function:\033[0m\n" +
